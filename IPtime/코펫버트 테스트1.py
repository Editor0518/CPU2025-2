...
csv_path = "patent_data_balanced.csv"
...
with mirrored_strategy.scope():
    ...
    # 드롭아웃 레이어 추가
    dropout_layer = keras.layers.Dropout(rate=0.2)(cls_out)  # 0.1~0.3 사이의 값으로 실험
    
    outputs = keras.layers.Dense(units=len(label2id), activation='softmax')(dropout_layer)
...
early_stop = EarlyStopping(
    ...
    patience=4,              # 개선 안 되는 epoch 수 (ex: 2번 연속)
...
# ===== 평가 및 저장 =====
model.save("korpatBERT_patent_model50.h5")
